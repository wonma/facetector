...
const FaceRecognition = ({ imageUrl, boxPosition, isLoading, noImgAtStart, onImgLoad }) => {
    return (
            <div className='center'>
                <div className='search-result' style={{ display: noImgAtStart }} >
                <img className='search-result__img' onLoad={onImgLoad} id='targetImg' src={imageUrl} alt='detection result' width='500px' height='auto' />
                    ...
                    <div className='bounding-box' style={{ top: boxPosition.top, right: boxPosition.right, left: boxPosition.left, bottom: boxPosition.bottom }} ></div>
                </div>
            </div>
