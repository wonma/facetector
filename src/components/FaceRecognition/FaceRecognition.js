...
const FaceRecognition = ({ imageUrl, boxPosition, isLoading }) => {
    return (
            <div className='center'>
                <div className='search-result'>
                    <img className='search-result__img' id='targetImg' src={imageUrl} alt='detection result' width='500px' height='auto' />
